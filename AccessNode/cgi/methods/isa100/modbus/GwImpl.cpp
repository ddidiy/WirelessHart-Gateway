...
/// @param p_szMapType - identifies the register map ID.
...
////////////////////////////////////////////////////////////////////////////////
bool GwImpl::setRow( const char * p_szRowValue, const char * p_szSection, const char * p_szMapType )
{	CConfigImpl oConfig;
	if( ! strcasecmp( p_szSection, "HOSTS") )
	{	char szFormattedRow[ 1024 ];
		sprintf( szFormattedRow, "%s,%s", p_szRowValue, p_szMapType);
		return oConfig.setConfigRow( CONF_MODBUS, p_szSection, "HOST", szFormattedRow, &sExtractInteger, 10 );
	}
	else if( ( !strcasecmp( p_szSection, "INPUT_REGISTERS") ) || ( !strcasecmp( p_szSection, "HOLDING_REGISTERS") ) )
		return oConfig.setVarInNthSection( CONF_MODBUS, p_szSection, "TYPE", p_szMapType, "REGISTER", p_szRowValue, &sExtractInteger, 10 );
...
/// 	same <TSAPID>,<ObjId>,<AttrId>,<Idx1>,<Idx2>,<MethId>
////////////////////////////////////////////////////////////////////////////////
bool GwImpl::delRow( const char * p_szRowValue, const char * p_szSection, const char * p_szMapType )
{	CConfigImpl oConfig;
	if( !strcasecmp( p_szSection, "HOSTS") )
	{
		return oConfig.delConfigRow( CONF_MODBUS, p_szSection, "HOST", p_szRowValue, &sExtractInteger, 10 );
	}
	else if( ( !strcasecmp( p_szSection, "INPUT_REGISTERS") ) || ( !strcasecmp( p_szSection, "HOLDING_REGISTERS") ) )
	{
		return oConfig.delVarInNthSection( CONF_MODBUS, p_szSection, "TYPE", p_szMapType, "REGISTER", p_szRowValue, &sExtractInteger, 10);
	}
