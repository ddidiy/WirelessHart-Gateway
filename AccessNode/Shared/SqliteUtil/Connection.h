...
public:
	...
	int		BindBlob ( int p_nPos, const void* p_pData, unsigned int p_nDataSize, void(*p_fctFree)(void*) = SQLITE_STATIC ); //use SQLITE_TRANSIENT if you want that sqlite to make a copy
...
public:
	...
	void BindParam(int parameterPos, const void* data, unsigned int dataSize) { m_oStmtHelper.BindBlob(parameterPos,data,dataSize, SQLITE_TRANSIENT); }
