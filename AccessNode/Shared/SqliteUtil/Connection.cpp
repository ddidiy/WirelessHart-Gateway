...
int		CSqliteStmtHelper::BindBlob ( int p_nPos, const void* p_pData, unsigned int p_nDataSize, void(*p_fctFree)(void*) )
{
	ResetStep();
	int res = sqlite3_bind_blob ( m_pStmt, p_nPos, p_pData, p_nDataSize, p_fctFree);
	m_oConnection.LogIfLastError(res, "BindBlob");
	return res;
}
