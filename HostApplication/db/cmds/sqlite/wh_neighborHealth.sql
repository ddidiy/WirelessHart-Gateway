...
SELECT DeviceID, 124, 0, datetime('now'), 0
...
SELECT col2, 62, DeviceID FROM Var, Devices WHERE col1='cmd_id' AND Address64 = '00-1B-1E-F8-70-00-55-31';

/*deviceID*/
INSERT INTO CommandParameters (CommandID, ParameterCode, ParameterValue)
SELECT col2, 62, DeviceID FROM Var, Devices WHERE col1='cmd_id' AND Address64 = '00-1B-1E-F8-70-00-55-32';
