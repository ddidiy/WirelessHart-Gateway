...
#ifndef APPDEVCONFIGNOTIFICATION_H_
#define APPDEVCONFIGNOTIFICATION_H_
...
class AppDevConfigNotification;
typedef boost::shared_ptr<AppDevConfigNotification> AppDevConfigNotificationPtr;

class AppDevConfigNotification: public AbstractAppCommand
{
public:
