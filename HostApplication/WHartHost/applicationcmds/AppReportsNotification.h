...
#ifndef APPREPORTSNOTIFICATION_H_
#define APPREPORTSNOTIFICATION_H_
...
class AppReportsNotification;
typedef boost::shared_ptr<AppReportsNotification> AppReportsNotificationPtr;

class AppReportsNotification: public AbstractAppCommand
{
public:
