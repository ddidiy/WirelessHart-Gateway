...
class App832Cmd;
typedef boost::shared_ptr<App832Cmd> App832CmdPtr;

class App832Cmd: public AbstractAppCommand
{
public:
...
public:
	App832Cmd(Device::DeviceStatus devStat, MAC& mac);
