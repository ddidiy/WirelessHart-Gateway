...
#ifndef APPTOPOLOGYNOTIFICATION_H_
#define APPTOPOLOGYNOTIFICATION_H_
...
class AppTopologyNotification;
typedef boost::shared_ptr<AppTopologyNotification> AppTopologyNotificationPtr;

class AppTopologyNotification: public AbstractAppCommand
{
public:
