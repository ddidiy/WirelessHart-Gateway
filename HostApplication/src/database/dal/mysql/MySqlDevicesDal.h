...
#ifndef MYSQLDEVICESDAL_H_
#define MYSQLDEVICESDAL_H_
...
class MySqlDevicesDal : public IDevicesDal
{
	LOG_DEF("hart7.hostapp.dal.MySqlDevicesDal");

public:
	MySqlDevicesDal(MySQLConnection& connection);
	virtual ~MySqlDevicesDal();
