...
/*
 * AllGatewayCommands.h
 *
 *	Contains all the commands that the Gateway can parse and compose.
 *
 *  Created on: Dec 15, 2008
 *      Author: nicu.dascalu
 */

#ifndef WHART_ALL_GATEWAY_COMMANDS_H
#define WHART_ALL_GATEWAY_COMMANDS_H
...
#endif /* WHART_ALL_GATEWAY_COMMANDS_H */
