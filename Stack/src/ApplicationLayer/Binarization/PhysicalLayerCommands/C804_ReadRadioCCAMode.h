...
uint8_t Compose_C804_ReadRadioCCAMode_Req(C804_ReadRadioCCAMode_Req* request, ComposerContext* context, BinaryStream* toStream);


uint8_t Parse_C804_ReadRadioCCAMode_Req(C804_ReadRadioCCAMode_Req* request, ParserContext* context, BinaryStream* fromStream);
