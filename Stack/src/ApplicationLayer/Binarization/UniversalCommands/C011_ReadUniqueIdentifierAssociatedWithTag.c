...
{
	context->cmdId = CMDID_C011_ReadUniqueIdentifierAssociatedWithTag;
...
{
	#if defined(_DEBUG)
// 		if (fromStream->remainingBytes < C011_ReqSize)
...
uint8_t Compose_C011_ReadUniqueIdentifierAssociatedWithTag_Resp(
		C011_ReadUniqueIdentifierAssociatedWithTag_Resp* response, ComposerContext* context, BinaryStream* toStream)
{
...
uint8_t Parse_C011_ReadUniqueIdentifierAssociatedWithTag_Resp(
		C011_ReadUniqueIdentifierAssociatedWithTag_Resp* response, ParserContext* context, BinaryStream* fromStream)
{
