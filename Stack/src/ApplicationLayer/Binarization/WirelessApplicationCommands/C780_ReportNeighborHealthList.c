...
{
  context->cmdId = CMDID_C780_ReportNeighborHealthList;
...
{
#if defined(_DEBUG)
//   if (fromStream->remainingBytes > C780_ReqSize)
		                    ...
		                    BinaryStream* fromStream )
{
  ...
  if (fromStream->remainingBytes < response->m_ucNoOfNeighborEntriesRead * 10)
