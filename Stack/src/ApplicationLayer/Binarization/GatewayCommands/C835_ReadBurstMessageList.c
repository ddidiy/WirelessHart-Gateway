...
uint8_t Compose_C835_ReadBurstMessageList_Req(C835_ReadBurstMessageList_Req* request, ComposerContext* context,
		BinaryStream* toStream)
{
	context->cmdId = CMDID_C835_ReadBurstMessageList;
 ...
 * @Debinarize
 */
uint8_t Parse_C835_ReadBurstMessageList_Req(C835_ReadBurstMessageList_Req* request, ParserContext* context,
		BinaryStream* fromStream)
{
	if (fromStream->remainingBytes < C835_ReqSize)
 ...
 *
 */
uint8_t Compose_C835_ReadBurstMessageList_Resp(C835_ReadBurstMessageList_Resp* response, ComposerContext* context,
		BinaryStream* toStream)
{
	context->cmdId = CMDID_C835_ReadBurstMessageList;
 ...
 *
 */
uint8_t Parse_C835_ReadBurstMessageList_Resp(C835_ReadBurstMessageList_Resp* response, ParserContext* context,
		BinaryStream* fromStream)
{
	if (fromStream->remainingBytes < C835_RespSize)
	{	return RCS_E05_TooFewDataBytesReceived;
	}
	...
	if (fromStream->remainingBytes < response->DifferentBurstCommandsNo * 6)
		return RCS_E05_TooFewDataBytesReceived;
