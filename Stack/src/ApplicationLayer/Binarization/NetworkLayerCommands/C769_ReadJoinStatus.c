...
uint8_t Compose_C769_ReadJoinStatus_Req(C769_ReadJoinStatus_Req* request, ComposerContext* context,
                                        BinaryStream* toStream)
{
  context->cmdId = CMDID_C769_ReadJoinStatus;

  return RCS_N00_Success;
}

uint8_t Parse_C769_ReadJoinStatus_Req(C769_ReadJoinStatus_Req* request, ParserContext* context,
                                      BinaryStream* fromStream)
{
  return RCS_N00_Success;
}

uint8_t Compose_C769_ReadJoinStatus_Resp(C769_ReadJoinStatus_Resp* response, ComposerContext* context,
                                         BinaryStream* toStream)
{
  context->cmdId = CMDID_C769_ReadJoinStatus;
...
uint8_t Parse_C769_ReadJoinStatus_Resp(C769_ReadJoinStatus_Resp* response, ParserContext* context,
                                       BinaryStream* fromStream)
{
