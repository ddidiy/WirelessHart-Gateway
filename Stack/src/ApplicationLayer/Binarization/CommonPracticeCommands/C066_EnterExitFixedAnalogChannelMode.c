...
{
	context->cmdId = CMDID_C066_EnterExitFixedAnalogChannelMode;
...
uint8_t Parse_C066_EnterExitFixedAnalogChannelMode_Req(C066_EnterExitFixedAnalogChannelMode_Req* request,
...
uint8_t Parse_C066_EnterExitFixedAnalogChannelMode_Resp(C066_EnterExitFixedAnalogChannelMode_Resp* response,
		ParserContext* context, BinaryStream* fromStream)
{
