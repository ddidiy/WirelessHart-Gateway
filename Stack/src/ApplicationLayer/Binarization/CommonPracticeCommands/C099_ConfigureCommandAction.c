...
uint8_t Compose_C099_ConfigureCommandAction_Req(C099_ConfigureCommandAction_Req* request, ComposerContext* context,
		BinaryStream* toStream)
{
	context->cmdId = CMDID_C099_ConfigureCommandAction;
#ifdef _DEBUG
...
uint8_t Parse_C099_ConfigureCommandAction_Req(C099_ConfigureCommandAction_Req* request, ParserContext* context,
		BinaryStream* fromStream)
{
	...
	if ( fromStream->remainingBytes <  request->commandSize )
	{
...
uint8_t Compose_C099_ConfigureCommandAction_Resp(C099_ConfigureCommandAction_Resp* response, ComposerContext* context,
		BinaryStream* toStream)
{
	context->cmdId = CMDID_C099_ConfigureCommandAction;
#ifdef _DEBUG
...
uint8_t Parse_C099_ConfigureCommandAction_Resp(C099_ConfigureCommandAction_Resp* response, ParserContext* context,
		BinaryStream* fromStream)
{
	...
	if ( fromStream->remainingBytes <  response->commandSize )
	{
		return RCS_E05_TooFewDataBytesReceived;
	}
