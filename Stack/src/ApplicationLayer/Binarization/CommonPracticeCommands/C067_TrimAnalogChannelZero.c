...
uint8_t Compose_C067_TrimAnalogChannelZero_Req(C067_TrimAnalogChannelZero_Req* request, ComposerContext* context,
		BinaryStream* toStream)
{
	context->cmdId = CMDID_C067_TrimAnalogChannelZero;
...
uint8_t Parse_C067_TrimAnalogChannelZero_Req(C067_TrimAnalogChannelZero_Req* request, ParserContext* context,
...
uint8_t Compose_C067_TrimAnalogChannelZero_Resp(C067_TrimAnalogChannelZero_Resp* response, ComposerContext* context,
		BinaryStream* toStream)
{
	context->cmdId = CMDID_C067_TrimAnalogChannelZero;
...
uint8_t Parse_C067_TrimAnalogChannelZero_Resp(C067_TrimAnalogChannelZero_Resp* response, ParserContext* context,
		BinaryStream* fromStream)
{
