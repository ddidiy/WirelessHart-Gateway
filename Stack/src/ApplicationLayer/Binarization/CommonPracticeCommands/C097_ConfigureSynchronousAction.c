...
{
	context->cmdId = CMDID_C097_ConfigureSynchronousAction;
...
uint8_t Parse_C097_ConfigureSynchronousAction_Req(C097_ConfigureSynchronousAction_Req* request, ParserContext* context,
