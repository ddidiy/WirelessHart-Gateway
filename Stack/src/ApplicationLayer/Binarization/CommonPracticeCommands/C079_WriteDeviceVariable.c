...
uint8_t Compose_C079_WriteDeviceVariable_Req(C079_WriteDeviceVariable_Req* request, ComposerContext* context,
		BinaryStream* toStream)
{
	context->cmdId = CMDID_C079_WriteDeviceVariable;
...
uint8_t Parse_C079_WriteDeviceVariable_Req(C079_WriteDeviceVariable_Req* request, ParserContext* context,
...
uint8_t Compose_C079_WriteDeviceVariable_Resp(C079_WriteDeviceVariable_Resp* response, ComposerContext* context,
		BinaryStream* toStream)
{
	context->cmdId = CMDID_C079_WriteDeviceVariable;
...
uint8_t Parse_C079_WriteDeviceVariable_Resp(C079_WriteDeviceVariable_Resp* response, ParserContext* context,
		BinaryStream* fromStream)
{
