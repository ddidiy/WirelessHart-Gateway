...
uint8_t Compose_C096_ReadSynchronousAction_Req(C096_ReadSynchronousAction_Req* request, ComposerContext* context,
		BinaryStream* toStream)
{
	context->cmdId = CMDID_C096_ReadSynchronousAction;
	STREAM_WRITE_UINT8(toStream, request->actionNo);
	return RCS_N00_Success;
}

uint8_t Parse_C096_ReadSynchronousAction_Req(C096_ReadSynchronousAction_Req* request, ParserContext* context,
...
uint8_t Compose_C096_ReadSynchronousAction_Resp(C096_ReadSynchronousAction_Resp* response, ComposerContext* context,
		BinaryStream* toStream)
{
	context->cmdId = CMDID_C096_ReadSynchronousAction;
...
uint8_t Parse_C096_ReadSynchronousAction_Resp(C096_ReadSynchronousAction_Resp* response, ParserContext* context,
		BinaryStream* fromStream)
{
