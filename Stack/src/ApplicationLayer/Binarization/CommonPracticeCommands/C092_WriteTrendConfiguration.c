...
uint8_t Compose_C092_WriteTrendConfiguration_Req(C092_WriteTrendConfiguration_Req* request, ComposerContext* context,
		BinaryStream* toStream)
{
	context->cmdId = CMDID_C092_WriteTrendConfiguration;
...
uint8_t Parse_C092_WriteTrendConfiguration_Req(C092_WriteTrendConfiguration_Req* request, ParserContext* context,
...
uint8_t Parse_C092_WriteTrendConfiguration_Resp(C092_WriteTrendConfiguration_Resp* response, ParserContext* context,
		BinaryStream* fromStream)
{
