...
uint8_t Parse_C078_ReadAggregatedCommands_Req(C078_ReadAggregatedCommands_Req* request,
...
uint8_t Parse_C078_ReadAggregatedCommands_Resp(C078_ReadAggregatedCommands_Resp* response,
		ParserContext* context, BinaryStream* fromStream);
