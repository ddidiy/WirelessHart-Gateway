...
uint8_t Compose_C113_CatchDeviceVariable_Req(C113_CatchDeviceVariable_Req* request, ComposerContext* context,
		BinaryStream* toStream)
{
	context->cmdId = CMDID_C113_CatchDeviceVariable;
...
uint8_t Parse_C113_CatchDeviceVariable_Req(C113_CatchDeviceVariable_Req* request, ParserContext* context,
...
uint8_t Compose_C113_CatchDeviceVariable_Resp(C113_CatchDeviceVariable_Resp* response, ComposerContext* context,
		BinaryStream* toStream)
{
	context->cmdId = CMDID_C113_CatchDeviceVariable;
...
uint8_t Parse_C113_CatchDeviceVariable_Resp(C113_CatchDeviceVariable_Resp* response, ParserContext* context,
		BinaryStream* fromStream)
{
