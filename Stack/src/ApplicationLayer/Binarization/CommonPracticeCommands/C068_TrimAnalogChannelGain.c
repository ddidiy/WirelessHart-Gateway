...
uint8_t Compose_C068_TrimAnalogChannelGain_Req(C068_TrimAnalogChannelGain_Req* request, ComposerContext* context,
		BinaryStream* toStream)
{
	context->cmdId = CMDID_C068_TrimAnalogChannelGain;
...
uint8_t Parse_C068_TrimAnalogChannelGain_Req(C068_TrimAnalogChannelGain_Req* request, ParserContext* context,
...
uint8_t Compose_C068_TrimAnalogChannelGain_Resp(C068_TrimAnalogChannelGain_Resp* response, ComposerContext* context,
		BinaryStream* toStream)
{
...
uint8_t Parse_C068_TrimAnalogChannelGain_Resp(C068_TrimAnalogChannelGain_Resp* response, ParserContext* context,
		BinaryStream* fromStream)
{
