...
{
	context->cmdId = CMDID_C054_ReadDeviceVariableInformation;
...
uint8_t Parse_C054_ReadDeviceVariableInformation_Req(C054_ReadDeviceVariableInformation_Req* request,
...
uint8_t Parse_C054_ReadDeviceVariableInformation_Resp(C054_ReadDeviceVariableInformation_Resp* response,
		ParserContext* context, BinaryStream* fromStream)
{
