...
uint8_t Compose_C086_ReadSubDeviceStatistics_Req(C086_ReadSubDeviceStatistics_Req* request, ComposerContext* context,
		BinaryStream* toStream)
{
	context->cmdId = CMDID_C086_ReadSubDeviceStatistics;

	STREAM_WRITE_UINT16(toStream, request->subDeviceIndex);
	return RCS_N00_Success;
}

uint8_t Parse_C086_ReadSubDeviceStatistics_Req(C086_ReadSubDeviceStatistics_Req* request, ParserContext* context,
...
uint8_t Parse_C086_ReadSubDeviceStatistics_Resp(C086_ReadSubDeviceStatistics_Resp* response, ParserContext* context,
		BinaryStream* fromStream)
{
