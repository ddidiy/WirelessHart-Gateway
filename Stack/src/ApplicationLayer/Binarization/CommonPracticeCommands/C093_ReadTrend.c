...
{
	context->cmdId = CMDID_C093_ReadTrend;
	STREAM_WRITE_UINT8(toStream, request->trendNo);
	return RCS_N00_Success;
}

uint8_t Parse_C093_ReadTrend_Req(C093_ReadTrend_Req* request, ParserContext* context, BinaryStream* fromStream)
{
...
uint8_t Parse_C093_ReadTrend_Resp(C093_ReadTrend_Resp* response, ParserContext* context, BinaryStream* fromStream)
{
