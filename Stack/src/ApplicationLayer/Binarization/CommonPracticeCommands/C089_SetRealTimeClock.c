...
uint8_t Compose_C089_SetRealTimeClock_Req(C089_SetRealTimeClock_Req* request, ComposerContext* context,
		BinaryStream* toStream)
{
	context->cmdId = CMDID_C089_SetRealTimeClock;
...
uint8_t Parse_C089_SetRealTimeClock_Req(C089_SetRealTimeClock_Req* request, ParserContext* context,
...
uint8_t Compose_C089_SetRealTimeClock_Resp(C089_SetRealTimeClock_Resp* response, ComposerContext* context,
		BinaryStream* toStream)
{
	context->cmdId = CMDID_C089_SetRealTimeClock;
...
uint8_t Parse_C089_SetRealTimeClock_Resp(C089_SetRealTimeClock_Resp* response, ParserContext* context,
		BinaryStream* fromStream)
{
