...
uint8_t Compose_C098_ReadCommandAction_Req(C098_ReadCommandAction_Req* request, ComposerContext* context,
		BinaryStream* toStream)
{
	context->cmdId = CMDID_C098_ReadCommandAction;
	STREAM_WRITE_UINT8(toStream, request->triggerAction);

	return RCS_N00_Success;
}

uint8_t Parse_C098_ReadCommandAction_Req(C098_ReadCommandAction_Req* request, ParserContext* context,
...
uint8_t Compose_C098_ReadCommandAction_Resp(C098_ReadCommandAction_Resp* response, ComposerContext* context,
		BinaryStream* toStream)
{
#ifdef _DEBUG
...
uint8_t Parse_C098_ReadCommandAction_Resp(C098_ReadCommandAction_Resp* response, ParserContext* context,
		BinaryStream* fromStream)
{
