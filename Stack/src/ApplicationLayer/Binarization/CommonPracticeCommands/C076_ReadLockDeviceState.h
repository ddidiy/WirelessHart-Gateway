...
uint8_t Parse_C076_ReadLockDeviceState_Req(C076_ReadLockDeviceState_Req* request,
...
uint8_t Parse_C076_ReadLockDeviceState_Resp(C076_ReadLockDeviceState_Resp* response,
		ParserContext* context, BinaryStream* fromStream);
