...
{
	context->cmdId = CMDID_C053_WriteDeviceVariableUnits;
...
uint8_t Parse_C053_WriteDeviceVariableUnits_Req(C053_WriteDeviceVariableUnits_Req* request, ParserContext* context,
...
uint8_t Parse_C053_WriteDeviceVariableUnits_Resp(C053_WriteDeviceVariableUnits_Resp* response, ParserContext* context,
		BinaryStream* fromStream)
{
