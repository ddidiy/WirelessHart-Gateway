...
uint8_t Compose_C114_ReadCaughtDeviceVariable_Req(C114_ReadCaughtDeviceVariable_Req* request, ComposerContext* context,
		BinaryStream* toStream)
{
	context->cmdId = CMDID_C114_ReadCaughtDeviceVariable;

	STREAM_WRITE_UINT8(toStream, request->destinationDeviceVariableCode);
	return RCS_N00_Success;
}

uint8_t Parse_C114_ReadCaughtDeviceVariable_Req(C114_ReadCaughtDeviceVariable_Req* request, ParserContext* context,
...
uint8_t Parse_C114_ReadCaughtDeviceVariable_Resp(C114_ReadCaughtDeviceVariable_Resp* response, ParserContext* context,
		BinaryStream* fromStream)
{
