...
uint8_t Compose_C062_ReadAnalogChannels_Req(C062_ReadAnalogChannels_Req* request, ComposerContext* context,
		BinaryStream* toStream)
{
	context->cmdId = CMDID_C062_ReadAnalogChannels;
#ifdef _DEBUG
...
uint8_t Parse_C062_ReadAnalogChannels_Req(C062_ReadAnalogChannels_Req* request, ParserContext* context,
		BinaryStream* fromStream)
{
	request->noOfChannelsNumberCodes = fromStream->remainingBytes;
	for (uint8_t i = 0; i < request->noOfChannelsNumberCodes; i++)
	{
...
uint8_t Compose_C062_ReadAnalogChannels_Resp(C062_ReadAnalogChannels_Resp* response, ComposerContext* context,
		BinaryStream* toStream)
{
...
uint8_t Parse_C062_ReadAnalogChannels_Resp(C062_ReadAnalogChannels_Resp* response, ParserContext* context,
		BinaryStream* fromStream)
{
