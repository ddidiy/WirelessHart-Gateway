...
uint8_t Compose_C108_WriteBurstModeCommandNumber_Req(C108_WriteBurstModeCommandNumber_Req* request, ComposerContext* context,
...
uint8_t Compose_C108_WriteBurstModeCommandNumber_Resp(C108_WriteBurstModeCommandNumber_Resp* response, ComposerContext* context,
		BinaryStream* toStream);
