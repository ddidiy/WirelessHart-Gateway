...
uint8_t Compose_C104_WriteBurstTrigger_Req(C104_WriteBurstTrigger_Req* request, ComposerContext* context,
		BinaryStream* toStream)
{
	context->cmdId = CMDID_C104_WriteBurstTrigger;
...
uint8_t Parse_C104_WriteBurstTrigger_Req(C104_WriteBurstTrigger_Req* request, ParserContext* context,
...
uint8_t Compose_C104_WriteBurstTrigger_Resp(C104_WriteBurstTrigger_Resp* response, ComposerContext* context,
		BinaryStream* toStream)
{
	context->cmdId = CMDID_C104_WriteBurstTrigger;
...
uint8_t Parse_C104_WriteBurstTrigger_Resp(C104_WriteBurstTrigger_Resp* response, ParserContext* context,
		BinaryStream* fromStream)
{
