...
{
	context->cmdId = CMDID_C074_ReadIOSystemCapabilities;

	return RCS_N00_Success;
}

uint8_t Parse_C074_ReadIOSystemCapabilities_Req(C074_ReadIOSystemCapabilities_Req* request, ParserContext* context,
...
uint8_t Parse_C074_ReadIOSystemCapabilities_Resp(C074_ReadIOSystemCapabilities_Resp* response, ParserContext* context,
		BinaryStream* fromStream)
{
