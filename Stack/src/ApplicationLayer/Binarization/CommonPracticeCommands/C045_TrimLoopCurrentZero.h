...
uint8_t Parse_C045_TrimLoopCurrentZero_Req(C045_TrimLoopCurrentZero_Req* request,
...
uint8_t Parse_C045_TrimLoopCurrentZero_Resp(C045_TrimLoopCurrentZero_Resp* response,
		ParserContext* context, BinaryStream* fromStream);
