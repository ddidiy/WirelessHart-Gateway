...
{
	context->cmdId = CMDID_C063_ReadAnalogChannelInformation;
	STREAM_WRITE_UINT8(toStream, request->channelNumberCode);

	return RCS_N00_Success;
}

uint8_t Parse_C063_ReadAnalogChannelInformation_Req(C063_ReadAnalogChannelInformation_Req* request,
...
uint8_t Parse_C063_ReadAnalogChannelInformation_Resp(C063_ReadAnalogChannelInformation_Resp* response,
		ParserContext* context, BinaryStream* fromStream)
{
