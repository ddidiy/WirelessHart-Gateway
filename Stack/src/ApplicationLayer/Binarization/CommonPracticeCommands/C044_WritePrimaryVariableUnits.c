...
{
	context->cmdId = CMDID_C044_WritePrimaryVariableUnits;

	STREAM_WRITE_UINT8(toStream, request->unitsCode);
	return RCS_N00_Success;
}

uint8_t Parse_C044_WritePrimaryVariableUnits_Req(C044_WritePrimaryVariableUnits_Req* request, ParserContext* context,
...
uint8_t Parse_C044_WritePrimaryVariableUnits_Resp(C044_WritePrimaryVariableUnits_Resp* response,
