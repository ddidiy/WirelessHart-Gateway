...
{
	context->cmdId = CMDID_C056_WriteDeviceVariableTransducerSerialNo;
...
uint8_t Compose_C056_WriteDeviceVariableTransducerSerialNo_Resp(
		C056_WriteDeviceVariableTransducerSerialNo_Resp* response, ComposerContext* context, BinaryStream* toStream)
{
	context->cmdId = CMDID_C056_WriteDeviceVariableTransducerSerialNo;
...
uint8_t Parse_C056_WriteDeviceVariableTransducerSerialNo_Resp(
		C056_WriteDeviceVariableTransducerSerialNo_Resp* response, ParserContext* context, BinaryStream* fromStream)
{
