...
{
	context->cmdId = CMDID_C065_WriteAnalogChannelRangeValues;
...
uint8_t Parse_C065_WriteAnalogChannelRangeValues_Req(C065_WriteAnalogChannelRangeValues_Req* request,
...
uint8_t Parse_C065_WriteAnalogChannelRangeValues_Resp(C065_WriteAnalogChannelRangeValues_Resp* response,
		ParserContext* context, BinaryStream* fromStream)
{
