...
uint8_t Compose_C085_ReadIOChannelStatistics_Req(C085_ReadIOChannelStatistics_Req* request, ComposerContext* context,
		BinaryStream* toStream)
{
	context->cmdId = CMDID_C085_ReadIOChannelStatistics;
...
uint8_t Parse_C085_ReadIOChannelStatistics_Req(C085_ReadIOChannelStatistics_Req* request, ParserContext* context,
...
uint8_t Parse_C085_ReadIOChannelStatistics_Resp(C085_ReadIOChannelStatistics_Resp* response, ParserContext* context,
		BinaryStream* fromStream)
{
