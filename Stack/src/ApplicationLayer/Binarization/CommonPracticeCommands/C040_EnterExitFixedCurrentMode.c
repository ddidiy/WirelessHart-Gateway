...
{
	context->cmdId = CMDID_C040_EnterExitFixedCurrentMode;

	STREAM_WRITE_FLOAT(toStream, request->level);
	return RCS_N00_Success;
}

uint8_t Parse_C040_EnterExitFixedCurrentMode_Req(C040_EnterExitFixedCurrentMode_Req* request, ParserContext* context,
