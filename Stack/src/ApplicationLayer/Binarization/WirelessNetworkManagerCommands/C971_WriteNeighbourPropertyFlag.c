...
uint8_t Compose_C971_WriteNeighbourPropertyFlag_Req(C971_WriteNeighbourPropertyFlag_Req* request, ComposerContext* context,
                                                    BinaryStream* toStream)
{
  context->cmdId = CMDID_C971_WriteNeighbourPropertyFlag;
...
* @Debinarize
*/
uint8_t Parse_C971_WriteNeighbourPropertyFlag_Req(C971_WriteNeighbourPropertyFlag_Req* request, ParserContext* context,
...
*
*/
uint8_t Compose_C971_WriteNeighbourPropertyFlag_Resp(C971_WriteNeighbourPropertyFlag_Resp* response, ComposerContext* context,
                                                     BinaryStream* toStream)
{
  context->cmdId = CMDID_C971_WriteNeighbourPropertyFlag;
...
*
*/
uint8_t Parse_C971_WriteNeighbourPropertyFlag_Resp(C971_WriteNeighbourPropertyFlag_Resp* response, ParserContext* context,
                                                   BinaryStream* fromStream)
{
