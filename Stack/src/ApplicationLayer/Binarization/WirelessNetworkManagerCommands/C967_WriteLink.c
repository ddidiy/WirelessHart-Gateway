...
uint8_t Compose_C967_WriteLink_Req(C967_WriteLink_Req* request, ComposerContext* context,
                                   BinaryStream* toStream)
{
  context->cmdId = CMDID_C967_WriteLink;
...
* @Debinarize
*/
uint8_t Parse_C967_WriteLink_Req(C967_WriteLink_Req* request, ParserContext* context,
...
*
*/
uint8_t Compose_C967_WriteLink_Resp(C967_WriteLink_Resp* response, ComposerContext* context,
                                    BinaryStream* toStream)
{
  context->cmdId = CMDID_C967_WriteLink;
...
*
*/
uint8_t Parse_C967_WriteLink_Resp(C967_WriteLink_Resp* response, ParserContext* context,
                                  BinaryStream* fromStream)
{
