...
uint8_t Compose_C965_WriteSuperframe_Req(C965_WriteSuperframe_Req* request, ComposerContext* context,
                                         BinaryStream* toStream)
{
  context->cmdId = CMDID_C965_WriteSuperframe;
...
* @Debinarize
*/
uint8_t Parse_C965_WriteSuperframe_Req(C965_WriteSuperframe_Req* request, ParserContext* context,
                                       BinaryStream* fromStream)
{
  ...
  request->m_ucSuperframeMode &= 0x81;		// ignore bits 6 to 1
...
*
*/
uint8_t Compose_C965_WriteSuperframe_Resp(C965_WriteSuperframe_Resp* response, ComposerContext* context,
                                          BinaryStream* toStream)
{
  context->cmdId = CMDID_C965_WriteSuperframe;
  ...
  STREAM_WRITE_UINT8(toStream, response->m_ucSuperframeMode & 0x81);		// discard bits 6 to 1
...
*
*/
uint8_t Parse_C965_WriteSuperframe_Resp(C965_WriteSuperframe_Resp* response, ParserContext* context,
                                        BinaryStream* fromStream)
{
