...
uint8_t Compose_C974_WriteRoute_Req(C974_WriteRoute_Req* request, ComposerContext* context,
                                    BinaryStream* toStream)
{
  context->cmdId = CMDID_C974_WriteRoute;
...
* @Debinarize
*/
uint8_t Parse_C974_WriteRoute_Req(C974_WriteRoute_Req* request, ParserContext* context,
...
*
*/
uint8_t Compose_C974_WriteRoute_Resp(C974_WriteRoute_Resp* response, ComposerContext* context,
                                     BinaryStream* toStream)
{
  context->cmdId = CMDID_C974_WriteRoute;
...
*
*/
uint8_t Parse_C974_WriteRoute_Resp(C974_WriteRoute_Resp* response, ParserContext* context,
                                   BinaryStream* fromStream)
{
