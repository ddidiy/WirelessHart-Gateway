...
uint8_t Compose_C968_DeleteLink_Req(C968_DeleteLink_Req* request, ComposerContext* context,
                                    BinaryStream* toStream)
{
  context->cmdId = CMDID_C968_DeleteLink;
...
* @Debinarize
*/
uint8_t Parse_C968_DeleteLink_Req(C968_DeleteLink_Req* request, ParserContext* context,
...
*
*/
uint8_t Compose_C968_DeleteLink_Resp(C968_DeleteLink_Resp* response, ComposerContext* context,
                                     BinaryStream* toStream)
{
  context->cmdId = CMDID_C968_DeleteLink;
...
*
*/
uint8_t Parse_C968_DeleteLink_Resp(C968_DeleteLink_Resp* response, ParserContext* context,
                                   BinaryStream* fromStream)
{
