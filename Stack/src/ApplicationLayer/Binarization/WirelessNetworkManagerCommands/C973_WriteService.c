...
uint8_t Compose_C973_WriteService_Req(C973_WriteService_Req* request, ComposerContext* context,
                                      BinaryStream* toStream)
{
  context->cmdId = CMDID_C973_WriteService;
...
* @Debinarize
*/
uint8_t Parse_C973_WriteService_Req(C973_WriteService_Req* request, ParserContext* context,
...
*
*/
uint8_t Compose_C973_WriteService_Resp(C973_WriteService_Resp* response, ComposerContext* context,
                                       BinaryStream* toStream)
{
  context->cmdId = CMDID_C973_WriteService;
...
*
*/
uint8_t Parse_C973_WriteService_Resp(C973_WriteService_Resp* response, ParserContext* context,
                                     BinaryStream* fromStream)
{
