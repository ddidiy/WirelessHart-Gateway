...
uint8_t Compose_C976_WriteSourceRoute_Req(C976_WriteSourceRoute_Req* request, ComposerContext* context,
                                          BinaryStream* toStream)
{
  context->cmdId = CMDID_C976_WriteSourceRoute;
...
* @Debinarize
*/
uint8_t Parse_C976_WriteSourceRoute_Req(C976_WriteSourceRoute_Req* request, ParserContext* context,
...
//    return RCM_E68_InvalidNoOfHops;
  ...
  if (fromStream->remainingBytes < ucHopsToCopy * 2)
...
*
*/
uint8_t Compose_C976_WriteSourceRoute_Resp(C976_WriteSourceRoute_Resp* response, ComposerContext* context,
                                           BinaryStream* toStream)
{
  context->cmdId = CMDID_C976_WriteSourceRoute;
...
*
*/
uint8_t Parse_C976_WriteSourceRoute_Resp(C976_WriteSourceRoute_Resp* response, ParserContext* context,
                                         BinaryStream* fromStream)
{
...
//     return RCM_E68_InvalidNoOfHops;
  ...
  if( fromStream->remainingBytes < response->m_ucHopsNo * 2 + 1)	// hops + no. of source routes left
    return RCS_E05_TooFewDataBytesReceived;
