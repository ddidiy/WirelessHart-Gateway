...
uint8_t Compose_C964_DeleteSession_Req(C964_DeleteSession_Req* request, ComposerContext* context,
                                       BinaryStream* toStream)
{
  context->cmdId = CMDID_C964_DeleteSession;
...
* @Debinarize
*/
uint8_t Parse_C964_DeleteSession_Req(C964_DeleteSession_Req* request, ParserContext* context,
...
*
*/
uint8_t Compose_C964_DeleteSession_Resp(C964_DeleteSession_Resp* response, ComposerContext* context,
                                        BinaryStream* toStream)
{
  context->cmdId = CMDID_C964_DeleteSession;
...
*
*/
uint8_t Parse_C964_DeleteSession_Resp(C964_DeleteSession_Resp* response, ParserContext* context,
                                      BinaryStream* fromStream)
{
