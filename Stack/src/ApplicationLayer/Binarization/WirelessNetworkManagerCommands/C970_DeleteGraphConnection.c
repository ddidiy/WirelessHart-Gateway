...
uint8_t Compose_C970_DeleteGraphConnection_Req(C970_DeleteGraphConnection_Req* request, ComposerContext* context,
                                               BinaryStream* toStream)
{
  context->cmdId = CMDID_C970_DeleteGraphConnection;
...
* @Debinarize
*/
uint8_t Parse_C970_DeleteGraphConnection_Req(C970_DeleteGraphConnection_Req* request, ParserContext* context,
...
*
*/
uint8_t Compose_C970_DeleteGraphConnection_Resp(C970_DeleteGraphConnection_Resp* response, ComposerContext* context,
                                                BinaryStream* toStream)
{
  context->cmdId = CMDID_C970_DeleteGraphConnection;
...
*
*/
uint8_t Parse_C970_DeleteGraphConnection_Resp(C970_DeleteGraphConnection_Resp* response, ParserContext* context,
                                              BinaryStream* fromStream)
{
