...
uint8_t Compose_C972_SuspendDevices_Req(C972_SuspendDevices_Req* request, ComposerContext* context,
                                        BinaryStream* toStream)
{
  context->cmdId = CMDID_C972_SuspendDevices;
...
* @Debinarize
*/
uint8_t Parse_C972_SuspendDevices_Req(C972_SuspendDevices_Req* request, ParserContext* context,
...
*
*/
uint8_t Compose_C972_SuspendDevices_Resp(C972_SuspendDevices_Resp* response, ComposerContext* context,
                                         BinaryStream* toStream)
{
  context->cmdId = CMDID_C972_SuspendDevices;
...
*
*/
uint8_t Parse_C972_SuspendDevices_Resp(C972_SuspendDevices_Resp* response, ParserContext* context,
                                       BinaryStream* fromStream)
{
