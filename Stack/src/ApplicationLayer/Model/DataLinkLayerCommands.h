...
enum
{
  ...
  C776_RespSize = 32,
  C781_RespSize =  2,
  C783_RespSize =  3, // or 7, 11, 15, ... (variable size)
  C784_RespSize =  5, // 13 or 21, 29, ... (variable size)
  C785_RespSize =  5, // or 9, 11, ... (variable size)
  C786_RespSize =  3,
  C787_RespSize =  3, // or 6, 9, 12, ... (variable size)
  C788_RespSize =  2,
  C795_RespSize =  5,
  C796_RespSize =  5,
  C806_RespSize =  4,
