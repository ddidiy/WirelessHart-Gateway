...
typedef enum
{
  ...
  // ...
  ExpandedDeviceTypeCode_WirelessHART_Network_Manager = 0xF980,
  ExpandedDeviceTypeCode_WirelessHART_Gateway = 0xF981,
  ExpandedDeviceTypeCode_Generic = 0xF982
...
typedef enum
{
  UnitsCodes_None = 0xFA,
  UnitsCodes_DegreesCelsius = 0x20,
  UnitsCodes_DegreesFahrenheit = 0x21,
  UnitsCodes_DegreesRankine = 0x22,
  UnitsCodes_Kelvin = 0x23,
