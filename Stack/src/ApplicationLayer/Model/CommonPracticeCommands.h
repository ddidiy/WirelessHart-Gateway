...
enum
{
	ShortFieldAddressSize = 1, LongFieldAddressSize = 5, MaxEmbeddedCommandsSize = 128, MaxNoOfEmbededCommands = 7, MaxBlockDataTransferLength = 128
};
...
enum
{
	...
	C078_ReqSize =  4,  // up to ??? max. bytes (variable size)
	C079_ReqSize =  8,
	C080_ReqSize =  1,
	C081_ReqSize =  1,
	C082_ReqSize =  7,
...
enum
{
	...
	C071_RespSize =  1,
	C072_RespSize =  0,
	C073_RespSize = 17, //22 for hart7
	C074_RespSize =  8,
	C075_RespSize = 12, // 12 for Hart5; 22 for Hart7
	C076_RespSize =  1,
	C077_RespSize =  7,  // up to ??? max. bytes (variable size)
	C078_RespSize =  6,  // ReqSize + 1Byte for RC + 1Byte for Ext Dev Type  // up to ??? max. bytes (variable size)
	C079_RespSize =  8,
	C080_RespSize = 10,
	C081_RespSize = 23,
	C082_RespSize =  7,
  ...
  C109_RespSize =  2,
	...
	C117_RespSize = 13,
	C118_RespSize =  2,
	C119_RespSize =  1, // up to 33, // can be truncated
	C512_RespSize =  3,
	C513_RespSize =  3
};
...
{
	float value; //units of seconds
}C034_WritePrimaryVariableDampingValue_Resp;
typedef enum
{
...
typedef struct
{
	...
	float upperValue;
	float lowerValue;
}C035_WritePrimaryVariableRangeValues_Resp;
typedef enum
{
...
}C040_EnterExitFixedCurrentMode_Resp;
typedef enum
{
...
{
	UnitsCodes unitsCode;
}C044_WritePrimaryVariableUnits_Resp;
typedef enum
{
...
{
	TransferFunctionCodes transferFunctionCode; //CommonTable3
}C047_WritePrimaryVariableTransferFunction_Resp;
typedef enum
{
...
{
	uint32_t serialNo; //_uint24_t
}C049_WritePrimaryVariableTransducerSerialNumber_Resp;
typedef enum
{
...
{
	uint8_t variableToBeZeroed;
}C052_SetDeviceVariableZero_Resp;
typedef enum
{
...
typedef struct
{
	uint8_t variable;
	UnitsCodes unitsCode;
}C053_WriteDeviceVariableUnits_Resp;
typedef enum
{
...
typedef struct
{
	uint8_t variableCode;
	float value; //units of seconds
}C055_WriteDeviceVariableDampingValue_Resp;
typedef enum
{
...
typedef struct
{
	uint8_t variableCode;
	uint32_t serialNo; //_uint24_t
}C056_WriteDeviceVariableTransducerSerialNo_Resp;
typedef enum
{
...
typedef struct
{
	AnalogChannelNumberCodes channelNumberCode;
	float dampingValue; //units of seconds
}C064_WriteAnalogChannelAdditionalDampingValue_Resp;
typedef enum
{
...
typedef struct
{
	...
	float upperRangeValue;
	float lowerRangeValue;
}C065_WriteAnalogChannelRangeValues_Resp;
typedef enum
{
...
typedef struct
{
	...
	UnitsCodes unitsCode;
	float channelLevel;
}C066_EnterExitFixedAnalogChannelMode_Resp;
typedef enum
{
...
typedef struct
{
	...
	UnitsCodes unitsCode;
	float channelLevel;
}C067_TrimAnalogChannelZero_Resp;
typedef enum
{
...
typedef struct
{
	...
	UnitsCodes unitsCode;
	float channelLevel;
}C068_TrimAnalogChannelGain_Resp;
...
typedef struct
{
	AnalogChannelNumberCodes channelNumberCode;
	TransferFunctionCodes transferFunctionCode;
}C069_WriteAnalogChannelTransferFunction_Resp;
...
typedef enum
{
      ...
      C075_E21 = RCS_E21_InIOCardNumber,
      C075_E22 = RCS_E22_InChannelNumber,
...
typedef enum
{
      ...
      C077_E21 = RCS_E21_InIOCardNumber,
      C077_E22 = RCS_E22_InChannelNumber,
...
#define MaxCmdSize 0xFF

typedef struct
{
  uint16_t CmdNo;
  uint8_t  CmdSize;
  uint8_t  CmdData[MaxCmdSize];  // can be a request/response; when response -> the first byte is the response code
}CmdType;

typedef struct
{
	uint8_t noOfCommands; // noOfCommands <= MaxNoOfEmbededCommands
	CmdType commands[MaxNoOfEmbededCommands];
        //uint16_t commandsNumbers[MaxNoOfEmbededCommands];
	//uint8_t commandsSizes[MaxNoOfEmbededCommands];
	//uint8_t embeddedCommandsBytes[MaxEmbeddedCommandsSize];
...
typedef struct
{
	...
	uint8_t noOfCommands; // noOfCommands <= MaxNoOfEmbededCommands
	CmdType commands[MaxNoOfEmbededCommands];
        //uint8_t commandsNumbers[MaxNoOfEmbededCommands];
	//uint8_t commandsSizes[MaxNoOfEmbededCommands];
	//uint8_t embeddedCommandsBytes[MaxEmbeddedCommandsSize]; //including command's Response Codes
...
typedef struct
{
	...
	UnitsCodes trimUnitsCode;
	float value;
}C082_WriteDeviceVariableTrimPoint_Resp;
...
{
	DeviceVariableCodes deviceVariableCode;
}C083_ResetDeviceVariableTrim_Resp;
...
typedef enum
{
      ...
      C085_E21 = RCS_E21_InIOCardNumber,
      C085_E22 = RCS_E22_InChannelNumber,
...
{
	uint8_t masterMode;
}C087_WriteIOSystemMasterMode_Resp;
...
{
	uint8_t retryCount;
}C088_WriteIOSystemRetryCount_Resp;
...
typedef struct
{
	...
	TrendControlCodes trendControlCode;
	DeviceVariableCodes deviceVariableCode;
	_time_t trendSamplePeriod; //CHEKME:[Ovidiu] this should be _time_t ???
}C092_WriteTrendConfiguration_Resp;
...
typedef struct
{
	...
	_date_t triggerDate;
	_time_t triggerTime;
}C097_ConfigureSynchronousAction_Resp;
...
typedef struct
{
	...
	uint8_t commandSize;
	uint8_t commandData[MaxEmbeddedCommandsSize];
}C099_ConfigureCommandAction_Resp;
...
typedef struct
{
	uint8_t burstMessage;
	uint16_t subDeviceIndex; //Index 0 indicates the I/O System itself
}C102_MapSubDeviceToBurstMessage_Resp;
...
{
	uint8_t burstMessage;
	_time_t updatePeriod;
	_time_t maxUpdatePeriod;
}C103_WriteBurstPeriod_Resp;
...
{
	uint8_t burstMessage;
	uint8_t requestIsEmpty; // >0 - if request is empty (for backward compability); 0 - otherwise
...
typedef struct
{
	...
	uint8_t commandNo;
	DeviceVariableCodes deviceVariableCode[MaxNoOfDeviceVariables];
	uint8_t burstMessage;
	uint8_t totalBurstMessagesCount;
...
{
	uint16_t commandNo;
	uint8_t burstMessageIsEmpty; // >0 - if burstMessage from request is not filled (for backward compability);  0 - otherwise
	uint8_t burstMessage;
...
typedef struct
{
	uint16_t commandNo;
	uint8_t burstMessage;
}C108_WriteBurstModeCommandNumber_Resp;
...
{
	uint8_t requestIsEmpty; // >0 - if request is empty (for backward compability); 0 - otherwise
	uint8_t burstMessageIsEmpty; // >0 - if is burstMessage from request is not filled (for backward compability); 0 - otherwise
...
typedef struct
{
	BurstModeControlCodes burstModeCode;
	uint8_t burstMessage;
}C109_BurstModeControl_Resp;


/******************** CMD 111 *************************/

//Table 11.1 Data Transfer Function Codes
typedef enum
{
  DataTransferFunction_TransferData = 0,
  DataTransferFunction_OpenPort = 1,
  DataTransferFunction_ResetPort = 2,
  DataTransferFunction_ReadyToClose = 3,
  DataTransferFunction_PortClosed = 1,
  DataTransferFunction_NotUsed = 250,
  DataTransferFunction_None = 251,
  DataTransferFunction_Unknown = 252,
  DataTransferFunction_Special = 253,
} DataTransferFunctions;

//Table 11.2 Port Assignments
typedef enum
{
  PortAssignment_ReadDeviceConfigurationFile = 2,
  PortAssignment_WriteDeviceConfigurationFile = 3,
  PortAssignment_ReadAllDeviceVariables = 4,
  PortAssignment_ReadErrorLog = 5,
  PortAssignment_ReadDataLog = 6,
  PortAssignment_PVStream = 7,
  PortAssignment_LocalPanel = 8
} PortAssignments;

typedef struct
{
	PortAssignments port;
	DataTransferFunctions function;
	uint8_t maxMasterSegmentLength;
	uint16_t startingMasterByteConter;
} C111_TransferServiceControl_Req;

typedef enum
{
      C111_NOO = RCS_N00_Success,
      C111_E02 = RCS_E02_InvalidSelection,
      C111_E05 = RCS_E05_TooFewDataBytesReceived,
      C111_E06 = RCS_E06_DeviceSpecificCommandError,
      C111_W08 = RCM_W08_SegmentLengthChanged,
      C111_E09 = RCM_E09_PortNotFound,
      C111_E10 = RCM_E10_PortInUse,
      C111_E11 = RCM_E11_MaximumPortsInUse,
      C111_E12 = RCM_E12_SegmentLengthTooSmall,
      C111_E16 = RCS_E16_AccessRestricted,
} C111_TransferServiceControl_RespCodes;

typedef struct
{
	PortAssignments port;
	DataTransferFunctions function;
	uint8_t maxSlaveSegmentLength;
	uint16_t startingMasterByteConter;
	uint16_t startingSlaveByteConter;
} C111_TransferServiceControl_Resp;
...
typedef struct
{
	PortAssignments port;
	DataTransferFunctions function;
	uint8_t noOfBytesTransferred;
	uint16_t masterByteConter;
	uint16_t slaveByteConter;
	uint8_t dataToSlave[MaxBlockDataTransferLength];
} C112_TransferService_Req;


typedef enum
{
      C112_NOO = RCS_N00_Success,
      C112_E02 = RCS_E02_InvalidSelection,
      C112_E05 = RCS_E05_TooFewDataBytesReceived,
      C112_E06 = RCS_E06_DeviceSpecificCommandError,
      C112_W08 = RCM_W08_SegmentLengthChanged,
      C112_E09 = RCM_E09_PortNotOpen,
      C112_E10 = RCM_E10_PortInUse,
      C112_E11 = RCM_E11_MaximumPortsInUse,
      C112_E12 = RCM_E12_SegmentLengthTooSmall,
      C112_E16 = RCS_E16_AccessRestricted,
      C112_E32 = RCS_E32_Busy,
      C112_E33 = RCS_E33_DelayedResponseInitiated,
      C112_E34 = RCS_E34_DelayedResponseRunning,
      C112_E35 = RCS_E35_DelayedResponseDead,
      C112_E36 = RCS_E36_DelayedResponseConflict,
} C112_TransferService_RespCodes;
...
typedef struct
{
	...
	uint16_t masterByteConter;
	uint16_t slaveByteConter;
	uint8_t dataToMaster[MaxBlockDataTransferLength];
} C112_TransferService_Resp;
...
enum
{
	MaxNoOfWriteEvents = 27
//CHECKME:[Ovidiu] check this!!! should by like in ReadEventNotificationSummary_Resp
};
...
typedef struct
{
	...
	uint8_t noOfWriteEvents;
	uint8_t eventMask[MaxNoOfWriteEvents];
}C116_WriteEventNotificationBitMask_Resp;
...
typedef struct
{
	...
	_time_t maximumUpdateTime;
	_time_t eventDeBounceInterval;
}C117_WriteEventNotificationTiming_Resp;
...
typedef struct
{
	uint8_t eventNo;
	EventNotificationControlCodes eventNotificationControlCode;
}C118_EventNotificationControl_Resp;
...
typedef struct
{
	...
	uint8_t deviceStatus;
	uint8_t command48Data[MaxLengthOf48Command];
}C119_AcknowledgeEventNotification_Resp;
