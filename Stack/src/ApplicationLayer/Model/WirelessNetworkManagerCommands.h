...
enum
{
  ...
  C974_ReqSize =  5,
  C975_ReqSize =  1,
  C976_ReqSize =  2,  // or 4, 6, 8, ... (variable size) // TODO: if <Number of hops> == 0 => C976_ReqSize = 2
  C977_ReqSize =  1
};
...
enum
{
  ...
  C974_RespSize =  6,
  C975_RespSize =  2,
  C976_RespSize =  3,  // or 5, 7, 9, ... (variable size); if <Number of hops> == 0 then RespSize = 3; (no hop entry)
  C977_RespSize =  1
};
...
typedef struct
{
  ...
  //uint16_t nmRouteId;		// WILL NOT BE SERIALIZED, used for NM
