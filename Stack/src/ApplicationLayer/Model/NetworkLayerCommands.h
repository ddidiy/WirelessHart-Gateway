...
#else
#define MAX_DEVICE_LIST_ENTRIES_NO        49      // for C814; may differ for the various device types
#endif
...
enum
{
  ...
  C803_RespSize =  2, // or 4, 6, 8, ... (variable size)
  C808_RespSize =  1,
  C809_RespSize =  1,
  C814_RespSize = 6, // or 11, ... (variable size)
  C815_RespSize =  8,
  C816_RespSize =  8,
  C817_RespSize =  5,
  C818_RespSize =  3,
...
typedef enum
{
    ...
    C800_W08 = RCM_W08_SetToNearestPossibleValue
...
typedef struct
{
    ...
    uint16_t m_peerNickname;	// OPTIONAL - NIVIS Specific -  serialized when m_ucReason is FF
    
//    uint16_t nmServiceID;	//WILL NOT BE SERIALIZED, used for NM
