...
enum
{
  ...
  C002_ReqSize =  0,
  C003_ReqSize =  0,
  C006_ReqSize_5RevNo = 1, // if master is HART rev. 5
  C006_ReqSize_7RevNo = 2, // is master is HART rev 7
  C007_ReqSize =  0,
  C008_ReqSize =  0,
  ...
  C021_ReqSize = 32,
  C022_ReqSize = 32,
  C038_ReqSize_5RevNo = 0, // if master is HART rev. 5
  C038_ReqSize_7RevNo = 2, // is master is HART rev 7
  C048_ReqSize_5RevNo = 0, // if master is HART rev. 5
  C048_ReqSize_6RevNo = 0, // if master is HART rev. 6
  C048_ReqSize_7RevNo = 25 // if master is HART rev. 7
};

enum
{
  C000_RespSize = 12, // 17 , // 12 for Hart 5;  22 for Hart 7
  C001_RespSize =  5,
  C002_RespSize =  8,
  C003_RespSize =  9, // variable size : 9, 14,19, 24
  C006_RespSize =  2,
  C007_RespSize =  2,
  C008_RespSize =  4,
  C009_RespSize = 9/*for hart 6 devs*/, // 13, 21, 29, ..., 69 (variable size)
  C011_RespSize = 11, //22 for hart7
  C012_RespSize = 24,
  C013_RespSize = 21,
  C014_RespSize = 16,
  C015_RespSize = 18,
  ...
  C019_RespSize =  3,
  C020_RespSize = 32,
  C021_RespSize = 17, //22 for hart 7
  C022_RespSize = 32,
  C038_RespSize =  2,
  C048_RespSize =  9  // variable size : 9, 13, 25
};
...
#define C006_WritePollingAddress_ReqSize                        C006_ReqSize_5RevNo
...
// the smallest value so that it can pass verif. tests
#define C038_ResetConfigurationChangedFlag_ReqSize              C038_ReqSize_5RevNo
// the smallest value so that it can pass verif. tests
#define C048_ReadAdditionalDeviceStatus_ReqSize                 C048_ReqSize_5RevNo
...
{
	char tag[8];
	char descriptorUsedByTheMasterForRecordKeeping[16];
...
enum {g_Cmd38ConfigurationChangedCounter_Any = 0xFFFF};
...
// typedef enum {
// 	C048_CommandSize_9 = 9,
// 	C048_CommandSize_13 = 13,
// 	C048_CommandSize_25 = 25
// }C048_CommandSize;
...
typedef struct {
	...
	uint8_t deviceOperatingMode;
	uint8_t standardizedStatus0;
	uint8_t customCommandSize;

//	C048_CommandSize customCommandSize;
	/*
	 * 5.30 Table 30. Standardized Status 1
	 * Code Description
	 * This Table is Reserved
...
}C048_ReadAdditionalDeviceStatus_Resp;
